...
#Gruvbox Light
def gruvbox_light():
	colors = [["#fbf1c7", "#fbf1c7"],  #background (dark grey) [0]
			   ["#bdae93", "#bdae93"],  #light grey [1]
			   ["#282828", "#282828"],  #foreground (white) [2]
			   ["#458588", "#458588"],  #blue [3]
			   ["#076678", "#076678"],  #light blue [4]
			   ["#98971a", "#98971a"],  #green [5]
			   ["#b57614", "#b57614"],  #orange [6]
	...
	foregroundColorTwo = "#076678"
	return colors, backgroundColor, foregroundColor, workspaceColor, foregroundColorTwo

#chadwm
def chadwm():
	colors = [["#232634", "#232634"],  #background (dark grey) [0]
			   ["#1e1e2e", "#1e1e2e"],  #light grey [1]
			   ["#cdd6f4", "#cdd6f4"],  #foreground (white) [2]
			   ["#b4befe", "#b4befe"],  #blue) [3]
			   ["#89b4fa", "#89b4fa"],  #light blue [4]
			   ["#a6e3a1", "#a6e3a1"],  #green [5]
			   ["#f2cdcd", "#f2cdcd"],  #orange [6]
			   ["#94e2d5", "#94e2d5"],  #orange [6]
			   ["#f5c2e7", "#f5c2e7"],  #pink [7]
			   ["#cba6f7", "#cba6f7"],  #purple [8]
			   ['#f38ba8', '#f38ba8'],  #red [9]
			   ["#f9e2af", "#f9e2af"]]  #yellow [10]
...
#transparent (wayland only)
def transparent():
	colors = [["#00000000", "#00000000"],  #background (dark grey) [0]
			   ["#1e1e2e", "#1e1e2e"],  #light grey [1]
			   ["#cdd6f4", "#cdd6f4"],  #foreground (white) [2]
			   ["#b4befe", "#b4befe"],  #blue) [3]
			   ["#89b4fa", "#89b4fa"],  #light blue [4]
