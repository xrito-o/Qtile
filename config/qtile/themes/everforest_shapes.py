...
logo = widget.TextBox(text="  ", font="JetBrainsMono Nerd Font Mono", mouse_callbacks={"Button1": open_rofi}, fontsize=20, background=colors[4], margin=4, padding=3)
...
cpu = widget.CPU(padding=5, font="JetBrainsMono Nerd Font Mono", format="  {freq_current}GHz {load_percent}%", foreground=colors[7], background=colors[0], **slash_powerlineRight)

temp = widget.ThermalSensor(padding=5, font="JetBrainsMono Nerd Font Mono", update_interval=1, format="󰔐 {temp:.0f}{unit}", tag_sensor="Tctl", foreground=colors[0], background=colors[4], **slash_powerlineRight)

mem = widget.Memory(padding=5, font="JetBrainsMono Nerd Font Mono", format="󰈀 {MemUsed:.0f}{mm}", background=colors[3], foreground=colors[0], **slash_powerlineRight)

clock = widget.Clock(padding=5, font="JetBrainsMono Nerd Font Mono", format="  %a %d %b %I:%M:%S", foreground=colors[6], background=colors[0], **slash_powerlineRight)

vol = widget.Volume(fmt="󰕾 {}", font="JetBrainsMono Nerd Font Mono", foreground=colors[0], background=colors[6], padding=10, **slash_powerlineRight)
